...
```
/_claude-sync import                          # プロジェクト全設定を調査して import 候補を提案
/_claude-sync import "_review スキルを持ってきたい"
/_claude-sync import "PR レビューの仕組みを dotfiles に取り込みたい"
/_claude-sync import "stop hook の処理"

/_claude-sync export                          # dotfiles 全設定を調査して export 候補を提案
/_claude-sync export "_commit"
/_claude-sync export "コミット・PR 関係をチームに配りたい"
/_claude-sync export "ralph エージェント"
```
