...
set -g status-right "#{?client_prefix,#[fg=#ffea00 bg=default]#[fg=#1a1b26 bg=#ffea00 bold]  #[fg=#ffea00 bg=default] -| split  g git  G gh  k keifu  j scratch  f sess  F proj  v copy  r reload  ? keys  Space menu,#[fg=#292e42#,bg=default]#{@sysstat}#[fg=#292e42#,bg=default] #{?#{==:#{client_key_table},off},#[fg=#545c7e]#[fg=#1a1b26 bg=#545c7e bold]  OFF #[fg=#545c7e bg=default],#{?#{==:#{@reload_mode},1},#[fg=#ff9e64]#[fg=#1a1b26 bg=#ff9e64 bold]  RELOAD #[fg=#ff9e64 bg=default],#{?#{==:#{window_name},[thumbs]},#[fg=#41a6b5]#[fg=#1a1b26 bg=#41a6b5 bold] 󰆤 THUMBS #[fg=#41a6b5 bg=default],#{?pane_in_mode,#[fg=#f7768e]#[fg=#1a1b26 bg=#f7768e bold] COPY #[fg=#f7768e bg=default],#{?pane_synchronized,#[fg=#73daca]#[fg=#1a1b26 bg=#73daca bold] SYNC #[fg=#73daca bg=default],#{?window_zoomed_flag,#[fg=#bb9af7]#[fg=#1a1b26 bg=#bb9af7 bold]  ZOOM #P/#{window_panes} #[fg=#bb9af7 bg=default],#[fg=#7aa2f7]#[fg=#1a1b26 bg=#7aa2f7] NORMAL #[fg=#7aa2f7 bg=default]}}}}}}#[fg=#9ece6a#,bg=default]#[fg=#1a1b26#,bg=#9ece6a]  #{@git_branch} #[fg=#9ece6a#,bg=default]#[fg=#7aa2f7#,bg=default]#[fg=#1a1b26#,bg=#7aa2f7]  %m/%d %H:%M #[fg=#7aa2f7#,bg=default]#[fg=#7dcfff#,bg=default]#[fg=#1a1b26#,bg=#7dcfff#,bold]  #h #[fg=#7dcfff#,bg=default]}"
