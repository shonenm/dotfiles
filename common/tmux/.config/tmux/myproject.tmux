...
set -g status-right "#{?client_prefix,#[fg=#FACC15 bg=default]#[fg=#0F1A15 bg=#FACC15 bold]  #[fg=#FACC15 bg=default] -| split  g git  G live-pr  k keifu  l scratch  f sess  F proj  v copy  r reload  ? keys  Space menu,#[fg=#1E2E28#,bg=default]#{@sysstat}#[fg=#1E2E28#,bg=default] #{?#{==:#{client_key_table},off},#[fg=#64748B]#[fg=#0F1A15 bg=#64748B bold]  OFF #[fg=#64748B bg=default],#{?#{==:#{@reload_mode},1},#[fg=#F59E0B]#[fg=#0F1A15 bg=#F59E0B bold]  RELOAD #[fg=#F59E0B bg=default],#{?#{==:#{window_name},[thumbs]},#[fg=#3B82F6]#[fg=#0F1A15 bg=#3B82F6 bold] 󰆤 THUMBS #[fg=#3B82F6 bg=default],#{?pane_in_mode,#[fg=#EF4444]#[fg=#0F1A15 bg=#EF4444 bold] COPY #[fg=#EF4444 bg=default],#{?pane_synchronized,#[fg=#22C55E]#[fg=#0F1A15 bg=#22C55E bold] SYNC #[fg=#22C55E bg=default],#{?#{||:#{window_zoomed_flag},#{@pzoom_pane}},#[fg=#A855F7]#[fg=#0F1A15 bg=#A855F7 bold]  ZOOM #P/#{window_panes} #[fg=#A855F7 bg=default],#[fg=#047857]#[fg=#0F1A15 bg=#047857] NORMAL #[fg=#047857 bg=default]}}}}}}#[fg=#22C55E#,bg=default]#[fg=#0F1A15#,bg=#22C55E]  #{?@git_branch,#{@git_branch},-} #[fg=#22C55E#,bg=default]#[fg=#8B5A2B#,bg=default]#[fg=#F8FAFC#,bg=#8B5A2B]  %m/%d %H:%M #[fg=#8B5A2B#,bg=default]#[fg=#3B82F6#,bg=default]#[fg=#0F1A15#,bg=#3B82F6#,bold]  #h #[fg=#3B82F6#,bg=default]}"
