...
## Skills
- Global skills: `quality-assure`, `safe-refactor`, `dependency-research`, `pr-review`, `incident-debug`, `deep-web-research`, `docs-research`, `github-research`, `safe-implementation`, `code-review`, `dependency-upgrade`
