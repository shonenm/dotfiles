...
SR_SYSSTAT="#[fg=${BG_HIGHLIGHT}${EC}bg=default]${LEFT}#[fg=#ff6600${EC}bg=${BG_HIGHLIGHT}]#(~/dotfiles/scripts/tmux-claude-usage.sh)#[fg=${FG_SUBTLE}${EC}bg=${BG_HIGHLIGHT}]|#[fg=#7DD3FC${EC}bg=${BG_HIGHLIGHT}]#(~/dotfiles/scripts/tmux-codex-usage.sh)#[fg=${FG_SUBTLE}${EC}bg=${BG_HIGHLIGHT}]|#[fg=#4285F4${EC}bg=${BG_HIGHLIGHT}]#(~/dotfiles/scripts/tmux-gemini-usage.sh)#[fg=${FG_SUBTLE}${EC}bg=${BG_HIGHLIGHT}]|#[fg=#9966FF${EC}bg=${BG_HIGHLIGHT}]#(~/dotfiles/scripts/tmux-cursor-usage.sh)#[fg=${FG_SUBTLE}${EC}bg=${BG_HIGHLIGHT}]|#(~/dotfiles/scripts/tmux-cpu.sh)#[fg=${FG_SUBTLE}${EC}bg=${BG_HIGHLIGHT}]|#(~/dotfiles/scripts/tmux-ram.sh)#(~/dotfiles/scripts/tmux-gpu.sh)#(~/dotfiles/scripts/tmux-storage.sh)#[fg=${BG_HIGHLIGHT}${EC}bg=default]${RIGHT} "
