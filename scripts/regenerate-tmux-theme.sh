...
CPU_ICON=$(printf '\xef\x8b\x9b')   # U+F2DB - microchip
RAM_ICON=$(printf '\xee\xbf\xb5')   # U+EFF5 - memory
...
set -g status-right "#[fg=#292e42,bg=default]${LEFT}#[fg=#a9b1d6,bg=#292e42]${CPU_ICON} #{cpu_fg_color}#{cpu_percentage}#[fg=#545c7e,bg=#292e42]|#[fg=#a9b1d6,bg=#292e42]${RAM_ICON} #{ram_fg_color}#{ram_percentage}#(~/dotfiles/scripts/tmux-gpu.sh)#(~/dotfiles/scripts/tmux-storage.sh)#[fg=#292e42,bg=default]${RIGHT} \\
#{?pane_in_mode,#[fg=#f7768e]${LEFT}#[fg=#1a1b26 bg=#f7768e bold] COPY #[fg=#f7768e bg=default]${RIGHT},#{?pane_synchronized,#[fg=#73daca]${LEFT}#[fg=#1a1b26 bg=#73daca bold] SYNC #[fg=#73daca bg=default]${RIGHT},#{?client_prefix,#[fg=#e0af68]${LEFT}#[fg=#1a1b26 bg=#e0af68 bold] PREFIX #[fg=#e0af68 bg=default]${RIGHT},#[fg=#7aa2f7]${LEFT}#[fg=#1a1b26 bg=#7aa2f7] NORMAL #[fg=#7aa2f7 bg=default]${RIGHT}}}}\\
