...
This system uses **workspace-based** notification management. Rather than trying to auto-detect which aerospace window you're running in, you manually register your git repository to a workspace using the `/_beacon` command.
...
For details on the `/_beacon` skill, see [`claude-skills.md`](claude-skills.md).
...
Remember to use `/_beacon` to map your environment to the correct workspace.
...
- [Claude Skills](claude-skills.md) - Skills reference (`/_beacon`, `/_commit`, `/_news`, `/_update-md`)
