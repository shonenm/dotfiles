...
This system uses **workspace-based** notification management. Rather than trying to auto-detect which aerospace window you're running in, you manually register your git repository to a workspace using the `/d-beacon` command.
...
For details on the `/d-beacon` skill, see [`claude-skills.md`](claude-skills.md).
...
Remember to use `/d-beacon` to map your environment to the correct workspace.
